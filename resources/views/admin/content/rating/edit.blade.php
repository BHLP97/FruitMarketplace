    ...
    <div class="app-content">
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <form action="{{route("admin.rating.update",$item->id)}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="categoryName">Category name</label>
                        <input type="text" class="form-control" id="categoryName" name="name" placeholder="Enter the category's name..." value="{{$item->name}}">
                    </div>
                    <div class="form-group">

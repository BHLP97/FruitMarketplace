    ...
    <div class="app-content">
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <form action="{{route("admin.admin.update",$item->id)}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="adminName">Tên</label>
                        <input type="text" class="form-control" id="adminName" name="name" placeholder="Input username..." value="{{$item->name}}">
                    </div>
                    <div class="form-group">
                        <label for="adminEmail">Email</label>
                        <input type="text" class="form-control" id="adminEmail" name="email" placeholder="Input email..." value="{{$item->email}}">
                    </div>
                    <div class="form-group">

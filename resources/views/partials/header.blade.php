			...
			<div class="row align-items-center">
							...
							<div class="bg-header-nav ">
								<nav class="header-nav">
									<ul class="item_big">
										...
										<li class="nav-item ">				
											<a class="a-img" href="/" title="Homepage">
												Homepage
											</a>
										</li>
										
										<li class="nav-item pe-3">
											<a class="a-img caret-down" href="/fruits" title="Fruits">
												Fruits
											</a>
											...
											<ul class="item_small">
												...
												<li>
													<a class="caret-down" href="/fruits?type=imported" title="Imported Fruits">
														Imported Fruits
													</a>
													<i class="fa fa-caret-down"></i>
													<ul>
														<li>
															<a href="/fruits?type=apples" title="Apples" class="a3">Apples</a>
														</li>
														<li>
															<a href="/fruits?type=grapes" title="Grapes" class="a3">Grapes</a>
														</li>
														<li>
															<a href="/fruits?type=persimmons" title="Dried Persimmons" class="a3">Dried Persimmons</a>
														</li>
													</ul>
												</li>

												<li>
													<a class="caret-down" href="/fruits?type=baskets&price_max=600" title="300k-700k Fruit Baskets">
														300k-600k Fruit Baskets
													</a>
													<i class="fa fa-caret-down"></i>
													<ul>
														<li>
												...
												<li>
													<a class="caret-down" href="/fruits?type=baskets&price_min=600&price_max=900" title="600k-900k Fruit Baskets">
														600k-900k Fruit Baskets
													</a>
													<i class="fa fa-caret-down"></i>
													<ul>
														<li>
												...
												<li>
													<a class="caret-down" href="/fruits?type=baskets&price_min=900" title="900k and above Fruit Baskets">
														900k or more Fruit Baskets
													</a>
													<i class="fa fa-caret-down"></i>
													<ul>
														<li>
												...
												<li>
													<a class="caret-down" href="/fruits?type=dried-seeds" title="Dried fruits and nutritious seeds">
														Dried fruits, nutritious seeds
													</a>
													<i class="fa fa-caret-down"></i>
													<ul>
														<li>
															<a href="/fruits?type=dried-fruits" title="Dried fruits" class="a3">Dried fruits</a>
														</li>
														<li>
															<a href="/fruits?type=seeds" title="Nutritious seeds" class="a3">Nutritious seeds</a>
														</li>
													</ul>
												</li>
										...
										<li class="nav-item">				
											<a class="a-img" href="/about-us" title="About us">
												About us
											</a>
										</li>
										<li class="nav-item ">				
				...
				<div class="col-xl-5 col-lg-9 col-md-9 col-sm-12 col-12 header-right">
					...
					<div class="nd-header-search nd-searchs">
						<form action="/search" method="get" class="nd-header-search-form has-validation-callback" role="search">
							<input type="text" name="query" class="search-auto form-control" placeholder="Looking for something?" autocomplete="off">
					...
					<div class="results-box"><div class="search-results"></div></div></div>
					...
					<div class="header-page-link">
						<ul class="group-account">
							<li>
								<div class="icon">
									<a href="/favorites" class="wishlist_header" title="Favorite products">
							...
							<li class="cart-drop">
								<div class="icon">
									<a href="javascript:void(0)" class="nd-header-cart" aria-label="See cart" title="Cart">
							...
							<li class="user">
								<div class="icon">
									<a href="/account" title="Your account" rel="nofollow">

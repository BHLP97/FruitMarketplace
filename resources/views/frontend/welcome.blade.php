...
<script type="text/javascript" src="https://www.barnesandnoble.com/resources/9a54652a9873b1c6ba523607dbff42ea7ab0011ba05c2" async ></script><script>window['adrum-start-time'] = new Date().getTime();</script>
...
<script type="text/javascript" src="https://prod.accdab.net/cdn/cs/ebiaklm7tP0ykOyjm7KGfgNcPyo.js" id="bcn" dvc="d" async defer></script>
                    ...
                    <script>var w=window;if(w.performance||w.mozPerformance||w.msPerformance||w.webkitPerformance){var d=document;AKSB=w.AKSB||{},AKSB.q=AKSB.q||[],AKSB.mark=AKSB.mark||function(e,_){AKSB.q.push(["mark",e,_||(new Date).getTime()])},AKSB.measure=AKSB.measure||function(e,_,t){AKSB.q.push(["measure",e,_,t||(new Date).getTime()])},AKSB.done=AKSB.done||function(e){AKSB.q.push(["done",e])},AKSB.mark("firstbyte",(new Date).getTime()),AKSB.prof={custid:"679473",ustr:"cookiepresent",originlat:"0",clientrtt:"44",ghostip:"23.50.232.107",ipv6:false,pct:"10",clientip:"27.72.101.191",requestid:"275819bf",region:"23331",protocol:"h2",blver:14,akM:"a",akN:"ae",akTT:"O",akTX:"1",akTI:"275819bf",ai:"238807",ra:"true",pmgn:"HTTP2Traffic",pmgi:"",pmp:"",qc:""},function(e){var _=d.createElement("script");_.async="async",_.src=e;var t=d.getElementsByTagName("script"),t=t[t.length-1];t.parentNode.insertBefore(_,t)}(("https:"===d.location.protocol?"https:":"http:")+"//ds-aksb-a.akamaihd.net/aksb.min.js")}</script>
                    </head>
...
<img width="99999" height="99999" style="pointer-events: none; position: absolute; top: 0; left: 0; width: 99vw; height: 99vh; max-width: 99vw; max-height: 99vh;"  src="data:image/svg+xml;base64," alt="BN Homepage Two-Image carousal">
<link rel="stylesheet" type="text/css" href="//css.css-bn.com/static/redesign/release/css/toolkit-bootstrap.min.css?v10.13.9&setviewtype=full"/>
<link rel="stylesheet" href="//css.css-bn.com/static/redesign/release/css/bn-responsive-wb.min.css?v10.13.9&setviewtype=full" media="print" onload="this.media='all'"/>
<link href="//dispatch.barnesandnoble.com/etc/designs/ccr/static/html/css/2022/bn_hompage2022.css?gsv=041723&v=hp040822" rel="stylesheet" type="text/css" media="print" onload="this.media='all'"/>
<script>
...
<script>document.write("<script type='text/javascript' src='//js.js-bn.com/static/redesign/release/js/head.js?v10.13.9'><\/script>");</script><!--// migration changes SLR-92 -->
<script>
    var url = "{{route('frontend.welcome')}}";
    function filterByCategory(){
        let id = $('#categoryId').val()
        console.log(id)
		$.ajax({
            type: 'get',
            url: url+'/filter/category/'+id,
			headers: {
				'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
			},
            traditional: true,
            success: function (data) {
                $('.pb-cont-scroller').html('');
				$('.pb-cont-scroller').html(data);
            }
		});
    }
...
if(!$('#miniCart').length) {
/*  if (hideCart) {
$container.html('<div id="miniCart" style="height: 150px; display:none;"><div class="triangle-up"></div><div class="mini-cart-spinner"></div>');
} else {
$container.html('<div id="miniCart" style="height: 150px"><div class="triangle-up"></div><div class="mini-cart-spinner"></div>');
}
*/
}
}
...
<!-- ATG-25918 -->
<script src="//assets.adobedtm.com/d55bc227c346/0aaa96eebcd0/launch-d923d12e2af4.min.js"></script>
<!-- ATG-26292 -->
<script src="https://apps.bazaarvoice.com/deployments/barnesandnoble/local_implementation/production/en_US/bv.js" async></script>
<script>
...
<script src="//dispatch.barnesandnoble.com/etc/designs/ccr/static/html/js/2023/bn-homepage2023.min.js?gsv=101923&v=hp040822" type="text/javascript" async></script>
<script type="text/javascript" src="//js.js-bn.com/static/redesign/srcs/js/vendor/com.liquidpixels.Resolve.js?v10.13.9" async></script>
...
<script>document.write("<script type='text/javascript' src='//js.js-bn.com/static/redesign/release/js/commerce-header.js?v10.13.9'><\/script>");</script><script src="https://www.google.com/recaptcha/api.js?render=6LdspeQUAAAAADObEWJ6oo7G-QvgkhiLgMgDXn_v" defer>
</script>
<script>
...
if(thisPathName !== "/w/the-heaven-earth-grocery-store-james-mcbride/1142821692" && thisPathName !== "/") {

if(106 > 1){
$('a.globalNavBannerLink').attr('href','https://www.barnesandnoble.com/w/the-heaven-earth-grocery-store-james-mcbride/1142821692?ean=9780593422946');
}else{
...
msgElem = `<picture><source media="(max-width: 600px)" srcset="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/11/PROD-28084_Global_Nav_Banner_BOTY_11-17-mobile.jpg"><source media="(min-width: 601px)" srcset="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/11/PROD-28084_Global_Nav_Banner_BOTY_11-17.jpg"><img src="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/11/PROD-28084_Global_Nav_Banner_BOTY_11-17.jpg" class="globalNavBannerImg" alt="Barnes &amp; Noble Book of the Year! The Heaven &amp; Earth Grocery Store. Shop Now "></picture>`;



$('a.globalNavBannerLink').html(msgElem);
$("a.globalNavBanner").on("click", function(){
set_cookie("globalNavBanner_barnes--noble-book-of-the-year-the-heaven--earth-grocery-store.-shop-now_na_text");
});
$(this).removeClass('hidden');

} else if(secondBanner && (thisPathName === "/w/the-heaven-earth-grocery-store-james-mcbride/1142821692" || thisPathName === "/")) {
...
msgElem2 = `<picture><source media="(max-width: 600px)" srcset="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/10/PROD-27893_Global_Nav_Banner_Memberhsip_DigitalContentInclusion_10-23-mobile.png"><source media="(min-width: 601px)" srcset="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/10/PROD-27893_Global_Nav_Banner_Memberhsip_DigitalContentInclusion_10-23.png"><img src="//dispatch.barnesandnoble.com/content/dam/ccr/global/global-nav-banner/2023/10/PROD-27893_Global_Nav_Banner_Memberhsip_DigitalContentInclusion_10-23.png" class="globalNavBannerImg" alt= "Premium Members Get Extra 10% Off AND Earn Rewards! New Stamps also on eBooks and Audiobooks.  Find Out More " /></picture>`;



$('a.globalNavBannerLink').html(msgElem2);
$("a.globalNavBanner").on("click", function(){
set_cookie("globalNavBanner_premium-members-get-extra-10-off-and-earn-rewards-new-stamps-also-on-ebooks-and-audiobooks.--find-out-more_na_text");
});
$(this).removeClass('hidden');
...
<section data-modifyslick="" class="featuredCategories homepage-module-container book perfectBookCont recordspotlight-six-item ">
    <div>
        @if(Auth::check())
    ...
    <div class="one-col-crsl-header mb-s">
        <h2 class="float-left">Book Reviews</h2>
        <select class="categoryFilter" id="categoryId" name="category_id" onchange="filterByCategory()">
...
<div id="thePerfectBook" class="homepage-module-container">
    <div class="pb-cont-scroller-wrapper">
        <div class="pb-cont-scroller">
            @foreach ($books as $book)
                <div class="pb-content">
                    <div class="prd-img-cont">
                        <div class="pb-image-cont">
                            <a href="{{$book->book_slug}}" class="image-container" title="view details">
                                <noscript>
    ...
    <div class="clear"></div>
    <div>
        <button onclick="displayAllOrders()">Display all Orders</button>
    </div>
</div>
</main>
...
<script src="//js.js-bn.com/static/redesign/release/js/bn.js?v10.13.9"></script><script async="true" src="//js.js-bn.com/static/redesign/release/js/modal.modals-browse.js?v10.13.9"></script><script>
...
<script type="text/javascript"
src="//js.js-bn.com/static/release/js/toolkit-responsive.js?v10.13.9" async></script>
<script defer="true" async="true" src="//js.js-bn.com/static/redesign/release/js/audiobook.main.js?v10.13.9"></script><script defer async type="text/javascript" src="https://request.eprotect.vantivcnp.com/eProtect/eProtect-api3.js"></script>
<script defer="true" async="true" src="//js.js-bn.com/static/redesign/release/js/worldpay.js?v10.13.9"></script><input type="hidden" id="analyticsEnabledFlag" value="true">
<script>
if(!$.isEmptyObject(digitalData)){
var digitalData1 = {"session":{"sessionID":"DC74E423DECC90BF5803D6F30FDF8169","serverName":"prodny_store02"},"page":{"timestamp":"Wed Nov 22 01:16:37 EST 2023","category":{"primaryCategory":"Home","hierarchy":"Home"},"pageInfo":{"pageType":"Home","pageName":"Home","language":"en","geoRegion":"US","breadCrumbs":["home"],"ipAddress":"45.61.68.120"}},"cart":{"price":{"shipping":0,"priceWithTax":0,"transationalTotal":0,"basePrice":0,"currency":"USD"}},"user":[{"profile":[{"profileInfo":{"profileID":"67708080165"}}]}]};
$.extend(digitalData,digitalData1);
}else{

var digitalData = {"session":{"sessionID":"DC74E423DECC90BF5803D6F30FDF8169","serverName":"prodny_store02"},"page":{"timestamp":"Wed Nov 22 01:16:37 EST 2023","category":{"primaryCategory":"Home","hierarchy":"Home"},"pageInfo":{"pageType":"Home","pageName":"Home","language":"en","geoRegion":"US","breadCrumbs":["home"],"ipAddress":"45.61.68.120"}},"cart":{"price":{"shipping":0,"priceWithTax":0,"transationalTotal":0,"basePrice":0,"currency":"USD"}},"user":[{"profile":[{"profileInfo":{"profileID":"67708080165"}}]}]};
...
<script>document.write("<script type='text/javascript' src='//js.js-bn.com/static/redesign/release/js/commerce-footer.js?v10.13.9'><\/script>");</script><script type="text/javascript">
/*CommerceHeaderFooter is the name of the library that we defined in webpack.config.js */
CommerceHeaderFooter.showFooter('footer', {env:'prod', consumer_host:'https://www.barnesandnoble.com', styling:'responsive'});
</script>
<script type="text/javascript"  src="/ihIfAUymV/NKyh/YHTmU/GmgOTZueg/1GuLJrfDDkuwEb/QGtpNgFaBQ/Uh59/KUwPFA8C"></script></body>
</html>
